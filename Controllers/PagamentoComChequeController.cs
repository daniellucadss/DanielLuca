...
namespace DanielLuca.Controllers
{
    public class PagamentoComChequeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroDoBanco,NomeDoBanco,Id,NomeDoCobrado,InformacoesAdicionais,Tipo")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroDoBanco,NomeDoBanco,Id,NomeDoCobrado,InformacoesAdicionais,Tipo")] PagamentoComCheque pagamentoComCheque)
        {
